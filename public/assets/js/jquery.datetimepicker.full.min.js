        ...
        (DateFormatter.prototype = {
            ...
            guessDate: function (e, t) {
                ...
                for (r = 0; r < s.length; r++) {
                    switch (
                        ((f = 2), (n = s[r]), (o = parseInt(n.substr(0, 2))), r)
                    ) {
                        case 0:
                            "m" === u[0] || "n" === u[0]
                                ? l.setMonth(o - 1)
                                ...
                                n.length < 4
                                    ? (l.setFullYear(
                                          parseInt(
                                              a
                                                  .toString()
                                                  .substr(0, 4 - n.length) + n
                                          )
                                      ),
                                      (f = n.length))
                                    : ((l.setFullYear = parseInt(
                                          n.substr(0, 4)
                                      )),
                                      (f = 4));
                            break;
                    ...
                    return "hide" === t
                        ...
                        : (e(this).hasClass("xdsoft_scroller_box") ||
                              ...
                              (p = function (e) {
                                  var t = d(e).y - f + g;
                                  0 > t && (t = 0),
                                      t + i[0].offsetHeight > m &&
                                          (t = m - i[0].offsetHeight),
                                      s.trigger(
                ...
                return (
                    (s = function (a) {
                        ...
                        var d,
                            ...
                            I = e(
                                '<div class="xdsoft_datepicker active"></div>'
                            ),
                            N = e(
                                ...
                                (C = e.extend(!0, {}, C, n)),
                                    ...
                                    (C.dayOfWeekStartPrev =
                                        0 === C.dayOfWeekStart
                                            ? 6
                                            : C.dayOfWeekStart - 1),
                                    J.trigger("xchange.xdsoft").trigger(
                                        "afterOpen.xdsoft"
                                    );
                            }),
                            J.data("options", C).on(
                            ...
                            E.find(".xdsoft_prev,.xdsoft_next").on(
                                ...
                                function () {
                                    ...
                                    !(function o(e) {
                                        ...
                                        t.hasClass(C.next) &&
                                        s - i - C.timeHeightInTimePicker >= d
                                            ? B.css(
                                                  "marginTop",
                                                  "-" +
                                                      (d +
                                ...
                                clearTimeout(u),
                                    (u = setTimeout(function () {
                                        ...
                                        for (
                                            ...
                                            y <
                                                j.currentTime.countDaysInMonth() ||
                                            p.getDay() !== C.dayOfWeekStart ||
                                            j.currentTime.getMonth() ===
                                                p.getMonth();
                                        ...
                                        if (
                                            ...
                                            for (
                                                y = 0;
                                                y < C.allowTimes.length;
                                                y += 1
                                            )
                                                (S = j
                                                    .strtotime(C.allowTimes[y])
                                                    .getHours()),
                                                    (l = j
                                                        .strtotime(
                                                            C.allowTimes[y]
                                        ...
                                        for (
                                            B.html(T),
                                                ...
                                                y = 0,
                                                y =
                                                    parseInt(C.yearStart, 10) +
                                                    C.yearOffset;
                                            y <=
                                            parseInt(C.yearEnd, 10) +
                                                C.yearOffset;
                                            y += 1
                                        )
                                            n +=
