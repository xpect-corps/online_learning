                            ...
                            <div class="card-body">
                                ...
                                <div class="course-card">
                                    ...
                                    <div id="collapseOne" class="card-collapse collapse" style="">
                                        <ul>
                                            <li>
                                                <p><img src="assets/img/icon/play.svg" alt=""
                                                        class="me-2">Lecture1.1 Introduction to the User Experience
                                                    Course</p>
                                                <div>
                                ...
                                <div class="course-card">
                                    ...
                                    <div id="coursefour" class="card-collapse collapse" style="">
                                        <ul>
                                            <li>
                                                <p><img src="assets/img/icon/play.svg" alt=""
                                                        class="me-2">Lecture4.1 Introduction to the User Experience
                                                    Course</p>
                                                <div>
                                                    <a href="javascript:;">Preview</a>
                                                    <span>02:53</span>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul>
                                        <li><img src="assets/img/icon/import.svg" class="me-2" alt=""> 11 hours
                                            on-demand video</li>
                                        <li><img src="assets/img/icon/play.svg" class="me-2" alt=""> 69
                                            downloadable resources</li>
                                        <li><img src="assets/img/icon/key.svg" class="me-2" alt=""> Full
                                            lifetime access</li>
                                        <li><img src="assets/img/icon/mobile.svg" class="me-2" alt=""> Access
                                            on mobile and TV</li>
                                        <li><img src="assets/img/icon/cloud.svg" class="me-2" alt="">
                                            Assignments</li>
                                        <li><img src="assets/img/icon/teacher.svg" class="me-2" alt="">
                            ...
                            <div class="card feature-sec">
                                <div class="card-body">
                                    ...
                                    <ul>
                                        ...
                                        <li><img src="assets/img/icon/chapter.svg" class="me-2" alt="">
                                            Chapters: <span>15</span></li>
                                        <li><img src="assets/img/icon/video.svg" class="me-2" alt="">
