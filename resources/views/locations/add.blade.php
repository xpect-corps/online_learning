            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-outline mb-3">
                        ...
                        <input type="text" id="location_desc" name="location_desc" class="form-control" placeholder="Location Description">
            ...
            <div class="col-md-12">
                <div class="form-outline mb-3">
                    ...
                    <div class="form-group row">
                        <textarea name="geojson" id="geojson" class="form-control d-none" required="required"></textarea>
                    </div>
                </div>
