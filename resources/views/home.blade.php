...
@section('content')
{{-- <img src="{{asset('assets/images/lock-image.png')}}" class="d-flex justify-center" style="z-index: 1;position: absolute;width: 450px;
margin-left: 30%;"> --}}
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="825">10</span></h4>
                                    <span class="badge badge-soft-danger fs-12"><i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>5.02 %</span>
                                </div>
                                <p class="text-muted text-truncate mb-0">App Users in this month</p>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-uppercase fw-medium text-muted mb-3"> Nagarasabha</p>
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="7522"></span></h4>
                                    <span class="badge badge-soft-success fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>3.58 %</span>
                                </div>
                                <p class="text-muted mb-0">Added in this month</p>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div>
                ...
                <div class="card card-animate">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                <p class="text-uppercase fw-medium text-muted text-truncate mb-3">Active App Users</p>
                                <div class="d-flex align-items-center mb-3">
                                ...
                                <p class="text-muted text-truncate mb-0">Active App Users this month</p>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header border-0 align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">App Overview</h4>
                        <div>
                        ...
                        <div class="row g-0 text-center">
                            <div class="col-6 col-sm-3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1"><span class="counter-value" data-target="1">1</span></h5>
                                    <p class="text-muted mb-0">Number App Users</p>
                                </div>
                            </div><!--end col-->
                            <div class="col-6 col-sm-3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1"><span class="counter-value" data-target="0">0</span></h5>
                                    <p class="text-muted mb-0">Active App Users</p>
                                </div>
                            </div><!--end col-->
                            <div class="col-6 col-sm-3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">$<span class="counter-value" data-target="10">0</span>k</h5>
                            ...
                            <div class="col-6 col-sm-3">
                                <div class="p-3 border border-dashed border-start-0 border-end-0">
                                    ...
                                    <p class="text-muted mb-0">App Up Time</p>
                                </div>
                            </div><!--end col-->
                        </div>
                    </div><!-- end card header -->
...
<div class="row" >
    ...
    <div class="col-xxl-4 col-lg-6">
        <div class="card card-height-100">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">App Status</h4>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                        <h2 class="me-3 ff-secondary mb-0">{{ 1 }}</h2>
                        <div>
                            <p class="text-muted mb-0">Total App Users</p>
                    ...
                    <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                        <p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-success align-middle me-2"></i> Perfect Users</p>
                        <div>
                            <span class="text-muted pe-5">125 Activities</span>
                            <span class="text-success fw-medium fs-13">15870hrs</span>
                        </div>
                    </div><!-- end -->
                    <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                        <p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-primary align-middle me-2"></i> Good Users</p>
                        <div>
                            <span class="text-muted pe-5">42 Activities</span>
                            <span class="text-success fw-medium fs-13">243hrs</span>
                        </div>
                    </div><!-- end -->
                    <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                        <p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-warning align-middle me-2"></i>Moderate Users </p>
                        <div>
                            <span class="text-muted pe-5">58 Activities</span>
                            <span class="text-success fw-medium fs-13">~2050hrs</span>
                        </div>
                    </div><!-- end -->
                    <div class="d-flex justify-content-between py-2">
                        <p class="fw-medium mb-0"><i class="ri-checkbox-blank-circle-fill text-danger align-middle me-2"></i> Yet to Start</p>
                        <div>
                            <span class="text-muted pe-5">89 Activities</span>
