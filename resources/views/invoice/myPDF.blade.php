        ...
        <tr>
            <td valign='top'>
                ...
                <table width='100%' height='' cellspacing='0' cellpadding='0'style="margin-bottom:5px;">
                    <tr style="background: rgb(240, 240, 240); ">
                        <td valign='top' width='50%' style='font-size:12px;  padding: 10px 0 10px;'> <strong>Invoice No:
                                <span
                                    style="font-weight:100; ">NH/SL/22-23/{{ $booking_details->id }}</span></strong>
                ...
                <table width='100%' height='' cellspacing='0' cellpadding='0' style="margin-bottom:15px">
                    ...
                    <tr>
                        <td> {{ $booking_details->customername->user->first_name }}
                            {{ $booking_details->customername->user->middle_name }}
                            {{ $booking_details->customername->user->last_name }}
                            (MRN:{{ $booking_details->customername->mr_number }})</td>
                    </tr>
                    <tr>
                        <td> Mobile: {{ $booking_details->customername->user->mobile_number }}</td>
                    </tr>
                    <tr>
                        <td>Clinician: {{ $task_details[0]->first_name }} {{ $task_details[0]->middle_name }}
                            {{ $task_details[0]->last_name }}
                            (Mob:{{ $task_details[0]->mobile_number }})</td>
                    </tr>
                </table>
                ...
                <table width='100%' cellspacing='0' cellpadding='2' border='' bordercolor='#fff'
                    ...
                    <tr style="border-bottom: 1px solid #0003;  ">
                        ...
                        <td valign='top' style='font-size:12px; text-align: center; padding:10px 0 10px;'>{{ $final_service_amount }}
                        </td>
                    </tr>
            </td>
        </tr>
    ...
    @if ($consumables_data != [])
        <table width='100%' cellspacing='0' cellpadding='2' border='' bordercolor='#fff'
            ...
            <tr style="border-bottom: 1px solid #0003;">
                ...
                <td></td>
                <td></td>
                <td valign='top' style='font-size:12px; text-align: center; padding:10px 0 10px;'>₹{{ $final_consumable_amount }}</td>
            </tr>
            </td>
            </tr>
        </table>
                ...
                <table width='100%' cellspacing='0' cellpadding='2' border='0'>
                    ...
                    <tr>
                        ...
                        <td align='right' style='font-size:12px;width:10%;'><span> &#x20b9; </span>
                            {{ $booking_details->discount_amount != 0 ? $booking_details->discount_amount : 0 }}</td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                            <td align='' style='font-size:12px;width: 30%;'>
                                ...
                                <img src="{{ asset('assets/images/phonepe.png') }}"
                                    style="width: 20%; padding:5px 0 5px 0 " alt="">
                                <img src="{{ asset('assets/images/gpay.png') }}" style="width: 20%;  padding:5px 0 5px 0"
                                    alt="">
